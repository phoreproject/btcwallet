...
[![GoDoc](https://godoc.org/github.com/phoreproject/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/phoreproject/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/phoreproject/btcwallet/walletdb

## Installation

```bash
$ go get github.com/phoreproject/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/phoreproject/btcwallet/walletdb#example-package--BasicUsage)  
